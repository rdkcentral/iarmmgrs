...
executable := $(exe_utils) $(exe_ds) $(exe_sysmgr)
else
executable := $(exe_platform_ir) $(exe_platform_fp) $(exe_platform_pwrstate) $(exe_sysmgr) $(exe_tr69Bus) $(exe_test) $(exe_mfr) $(exe_ds)
endif
else	
executable := $(exe_platform_ir) $(exe_platform_fp) $(exe_platform_pwrstate) $(exe_sysmgr) $(exe_tr69Bus) $(exe_test) $(exe_ds)
endif	
