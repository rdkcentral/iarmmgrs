...
ux_controller::ux_controller(unsigned int in_id, const std::string &in_name, deviceType_t in_deviceType) : id(in_id), name(in_name), deviceType(in_deviceType), invalidateAsyncBootloaderPattern(false), firstPowerTransitionComplete(false), mutex()
{
